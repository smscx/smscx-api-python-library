...
class RentedNumbersResponse(ModelNormal):
    ...
    def api_types():
        ...
        lazy_import()
        return {
            'data': ([DataRentedNumbers],),  # noqa: E501
        }
    ...
    def _from_api_data(cls, data, *args, **kwargs):  # noqa: E501
        """RentedNumbersResponse - a model

        Args:
            data ([DataRentedNumbers]): List of rented phone numbers
