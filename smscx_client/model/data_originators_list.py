...
class DataOriginatorsList(ModelNormal):
    ...
    def api_types():
        ...
        return {
            'id': (int,),  # noqa: E501
            'originator': (str,),  # noqa: E501
            #'two_way': (TwoWay,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, id, originator, is_default, approved, created_at, *args, **kwargs):  # noqa: E501
        """DataOriginatorsList - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, originator, is_default, approved, created_at, *args, **kwargs):  # noqa: E501
        """DataOriginatorsList - a model
