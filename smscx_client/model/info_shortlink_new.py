...
class InfoShortlinkNew(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, id, name, original_url, short_url, *args, **kwargs):  # noqa: E501
        """InfoShortlinkNew - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, original_url, short_url, *args, **kwargs):  # noqa: E501
        """InfoShortlinkNew - a model
