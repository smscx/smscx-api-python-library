...
class InfoGroupsAddContactsResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, total_cost, total_valid, total_invalid, total_duplicates, total_phone_numbers, invalid, *args, **kwargs):  # noqa: E501
        """InfoGroupsAddContactsResponse - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, total_cost, total_valid, total_invalid, total_duplicates, total_phone_numbers, invalid, *args, **kwargs):  # noqa: E501
        """InfoGroupsAddContactsResponse - a model
