...
class AccountBalance(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, balance, currency, billing, *args, **kwargs):  # noqa: E501
        """AccountBalance - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, balance, currency, billing, *args, **kwargs):  # noqa: E501
        """AccountBalance - a model
