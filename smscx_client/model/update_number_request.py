...
class UpdateNumberRequest(ModelNormal):
    ...
    def _from_api_data(cls, *args, **kwargs):  # noqa: E501
        """UpdateNumberRequest - a model


            phone_number (str): Phone number in international E.164 format to replace the current phone number.. [optional]  # noqa: E501
