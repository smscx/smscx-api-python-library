...
class InfoOptoutsNew(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, total_valid, total_invalid, total_duplicates, total_phone_numbers, phone_numbers_by_country, invalid, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, total_valid, total_invalid, total_duplicates, total_phone_numbers, phone_numbers_by_country, invalid, *args, **kwargs):  # noqa: E501
        """InfoOptoutsNew - a model
