...
class DataGroups(ModelNormal):
    ...
    attribute_map = {
        ...
        'total_optouts': 'totalOptouts',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, id, name, total_phone_numbers, total_cost, total_optouts, created_at, *args, **kwargs):  # noqa: E501
        """DataGroups - a model
        ...
        self.total_optouts = total_optouts
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, total_phone_numbers, total_cost, total_optouts, created_at, *args, **kwargs):  # noqa: E501
        """DataGroups - a model
