...
class ReportsCampaignsRespone(ModelNormal):
    ...
    def api_types():
        ...
        lazy_import()
        return {
            'info': (InfoReportsCampaigns,),  # noqa: E501
            'data': ([DataReportsCampaigns],),  # noqa: E501
    ...
    def _from_api_data(cls, info, data, paging, *args, **kwargs):  # noqa: E501
        """ReportsCampaignsRespone - a model

        Args:
            info (InfoReportsCampaigns):
            data ([DataReportsCampaigns]): 
            paging (Paging):
