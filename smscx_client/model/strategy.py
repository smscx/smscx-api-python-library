...
class Strategy(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, channel, *args, **kwargs):  # noqa: E501
        """Strategy - a model
        ...
        Args:
            ...
            template_id (int): Identifier of the approved Viber or Whatsapp template. [optional]  # noqa: E501
            text (str): The text message for channel SMS (failover). [optional]  # noqa: E501
        """
