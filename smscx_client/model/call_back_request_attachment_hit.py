...
class CallBackRequestAttachmentHit(ModelNormal):


    allowed_values = {
        ('event',): {
            'HIT': "attachment_hit",
            'HIT_UPDATE': "attachment_hit_update",
        },
    }
    ...
    def api_types():
        ...
        return {
            'event': (str,),  # noqa: E501
            'data': ([DataShortlinkHit],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, event, data, *args, **kwargs):  # noqa: E501
        """CallBackRequestAttachmentHit - a model

        Args:
            event (str):
            data ([DataShortlinkHit]): Event type data, grouped in multiple objects (up to 200 in a request)
    ...
    @convert_js_args_to_python_args
    def __init__(self, event, data, *args, **kwargs):  # noqa: E501
        """CallBackRequestAttachmentHit - a model
