...
def lazy_import():
    from smscx_client.model.info_edit_rent import InfoEditRent
    globals()['InfoEditRent'] = InfoEditRent


class EditRentResponse(ModelNormal):
