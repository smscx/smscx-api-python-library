...
class RentNumbersResponse(ModelNormal):
    ...
    def api_types():
        ...
        lazy_import()
        return {
            'data': ([DataAvailableNumbersRent],),  # noqa: E501
        }
    ...
    def _from_api_data(cls, data, *args, **kwargs):  # noqa: E501
        """RentNumbersResponse - a model

        Args:
            data ([DataAvailableNumbersRent]): List of available phone numbers for rent
