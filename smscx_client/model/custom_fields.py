...
class CustomFields(ModelNormal):
    ...
    def api_types():
        ...
        """
        return {
            'custom_field_name': ({str: (str,)},),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, custom_field_name, *args, **kwargs):  # noqa: E501
        """CustomFields - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, custom_field_name, *args, **kwargs):  # noqa: E501
        """CustomFields - a model
