...
class CallBackRequestDlrUpdate(ModelNormal):
    ...
    def _from_api_data(cls, data, *args, **kwargs):  # noqa: E501
        """CallBackRequestDlrUpdate - a model

        Args:
            data ([DataDlrUpdate]): Event data, grouped in multiple objects (up to 200 in a request)

        Keyword Args:
            event (str): defaults to "dlr_update", must be one of ["dlr_update", ]  # noqa: E501
        ...
        event = kwargs.get('event', "dlr_update")
