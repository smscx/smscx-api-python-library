...
class NumbersValidateResponse(ModelNormal):
    ...
    def api_types():
        ...
        lazy_import()
        return {
            'info': (InfoNumbersValidate,),  # noqa: E501
            'data': ([DataNumbersValidate],),  # noqa: E501
        }
    ...
    def _from_api_data(cls, info, data, *args, **kwargs):  # noqa: E501
        """NumbersValidateResponse - a model

        Args:
            info (InfoNumbersValidate):
            data ([DataNumbersValidate]): 
