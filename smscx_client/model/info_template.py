...
class InfoTemplate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, id, name, text, channel, *args, **kwargs):  # noqa: E501
        """InfoTemplate - a model
        ...
        Args:
            ...
            type (str): Only for channel viber or whatsapp. [optional]  # noqa: E501
            approved (bool): Only for channel viber or whatsapp. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, text, channel, *args, **kwargs):  # noqa: E501
        """InfoTemplate - a model
