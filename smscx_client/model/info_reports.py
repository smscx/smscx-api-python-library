...
class InfoReports(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, total_phone_numbers, total_cost, total_parts, *args, **kwargs):  # noqa: E501
        """InfoReports - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, total_phone_numbers, total_cost, total_parts, *args, **kwargs):  # noqa: E501
        """InfoReports - a model
