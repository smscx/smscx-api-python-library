...
class ShortlinkNewRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, url, *args, **kwargs):  # noqa: E501
        """ShortlinkNewRequest - a model

        Args:
            url (str): A valid URL


            name (str): If this parameter is omitted the name of the shortlink will be set by the API eg. \"Short link \\#433\". [optional]  # noqa: E501
        """
