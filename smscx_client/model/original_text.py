...
class OriginalText(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, text, length, parts, encoding, *args, **kwargs):  # noqa: E501
        """OriginalText - a model

        Args:
            text (str): Text before the transliteration
            length (int): Length of the original text
            parts (int): Parts of the original text
    ...
    @convert_js_args_to_python_args
    def __init__(self, text, length, parts, encoding, *args, **kwargs):  # noqa: E501
        """OriginalText - a model
