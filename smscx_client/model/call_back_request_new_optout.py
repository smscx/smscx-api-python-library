...
class CallBackRequestNewOptout(ModelNormal):
    ...
    def _from_api_data(cls, data, *args, **kwargs):  # noqa: E501
        """CallBackRequestNewOptout - a model

        Args:
            data ([DataNewOptout]): Event data, grouped in multiple objects (up to 200 in a request)

        Keyword Args:
            event (str): defaults to "new_optout", must be one of ["new_optout", ]  # noqa: E501
        ...
        event = kwargs.get('event', "new_optout")
