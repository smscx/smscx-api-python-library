...
class OriginatorNewRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, originator, *args, **kwargs):  # noqa: E501
        """OriginatorNewRequest - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, originator, *args, **kwargs):  # noqa: E501
        """OriginatorNewRequest - a model
