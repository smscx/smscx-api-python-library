...
class Model400InvalidPhoneNumbers(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, error, invalid, *args, **kwargs):  # noqa: E501
        """Model400InvalidPhoneNumbers - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, error, invalid, *args, **kwargs):  # noqa: E501
        """Model400InvalidPhoneNumbers - a model
