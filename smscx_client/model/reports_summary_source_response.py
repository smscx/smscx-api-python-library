...
def lazy_import():
    ...
    globals()['ReportsSummarySourceResponseDataValue'] = ReportsSummarySourceResponseDataValue


class ReportsSummarySourceResponse(ModelNormal):
    ...
    def api_types():
        ...
        lazy_import()
        return {
            'data': ({str: (ReportsSummarySourceResponseDataValue,)},),  # noqa: E501
        }
    ...
    def _from_api_data(cls, data, *args, **kwargs):  # noqa: E501
        """ReportsSummarySourceResponse - a model

        Args:
            data ({str: (ReportsSummarySourceResponseDataValue,)}):
