...
class VerifyPinResponse(ModelNormal):
    ...
    def _from_api_data(cls, *args, **kwargs):  # noqa: E501
        """VerifyPinResponse - a model

        Args:

        Keyword Args:
            status (str): Will have value `VERIFIED` if the pin entered is correct. defaults to "VERIFIED"  # noqa: E501
