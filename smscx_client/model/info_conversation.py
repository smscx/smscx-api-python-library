...
class InfoConversation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, conversation_id, phone_number, country_iso, first_name, last_name, *args, **kwargs):  # noqa: E501
        """InfoConversation - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, conversation_id, phone_number, country_iso, first_name, last_name, *args, **kwargs):  # noqa: E501
        """InfoConversation - a model
