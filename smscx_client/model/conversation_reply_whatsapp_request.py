...
class ConversationReplyWhatsappRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, text, rich_media, *args, **kwargs):  # noqa: E501
        """ConversationReplyWhatsappRequest - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, text, rich_media, *args, **kwargs):  # noqa: E501
        """ConversationReplyWhatsappRequest - a model
