...
class CallBackRequestReceiveSms(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, data, *args, **kwargs):  # noqa: E501
        """CallBackRequestReceiveSms - a model

        Args:
            data ([DataReceiveSms]): Event data, grouped in multiple objects (up to 200 in a request)

        Keyword Args:
            event (str): defaults to "receive_sms", must be one of ["receive_sms", ]  # noqa: E501
        ...
        event = kwargs.get('event', "receive_sms")
