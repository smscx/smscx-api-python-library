...
class TwoWay(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, type, country_iso, expire_date, *args, **kwargs):  # noqa: E501
        """TwoWay - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, country_iso, expire_date, *args, **kwargs):  # noqa: E501
        """TwoWay - a model
