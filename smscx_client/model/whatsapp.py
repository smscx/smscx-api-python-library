...
class Whatsapp(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, dlr_callback, receive_callback, quiet_hours, *args, **kwargs):  # noqa: E501
        """Whatsapp - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, dlr_callback, receive_callback, quiet_hours, *args, **kwargs):  # noqa: E501
        """Whatsapp - a model
