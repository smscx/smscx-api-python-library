...
class TextAnalysis(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, length, unicode, parts, *args, **kwargs):  # noqa: E501
        """TextAnalysis - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, length, unicode, parts, *args, **kwargs):  # noqa: E501
        """TextAnalysis - a model
