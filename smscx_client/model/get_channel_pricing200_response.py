...
class GetChannelPricing200Response(ModelComposed):
    ...
    def api_types():
        ...
        lazy_import()
        return {
            'country_code': (ViberWhatsappPricing,),  # noqa: E501
        }
    ...
    def _from_api_data(cls, *args, **kwargs):  # noqa: E501
        """GetChannelPricing200Response - a model


            country_code (ViberWhatsappPricing): [optional]  # noqa: E501
        """
