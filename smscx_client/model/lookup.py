...
class Lookup(ModelNormal):
    ...
    def api_types():
        ...
        """
        return {
            'lookup_callback': (str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        'lookup_callback': 'lookupCallback',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, lookup_callback, *args, **kwargs):  # noqa: E501
        """Lookup - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, lookup_callback, *args, **kwargs):  # noqa: E501
        """Lookup - a model
