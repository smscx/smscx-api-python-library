...
class SendMultichannelCampaignResponse(ModelNormal):
    ...
    def api_types():
        ...
        lazy_import()
        return {
            'info': (InfoMultichannelCampaign,),  # noqa: E501
            'data': ([DataMultichannel],),  # noqa: E501
        }
    ...
    def _from_api_data(cls, info, data, *args, **kwargs):  # noqa: E501
        """SendMultichannelCampaignResponse - a model

        Args:
            info (InfoMultichannelCampaign):
            data ([DataMultichannel]): 
