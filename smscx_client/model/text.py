...
class Text(ModelNormal):
    ...
    def api_types():
        ...
        lazy_import()
        return {
            'original': (OriginalText,),  # noqa: E501
            'replaced': (ReplacedText,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, original, replaced, *args, **kwargs):  # noqa: E501
        """Text - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, original, replaced, *args, **kwargs):  # noqa: E501
        """Text - a model
