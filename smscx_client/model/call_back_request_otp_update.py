...
class CallBackRequestOtpUpdate(ModelNormal):
    ...
    def _from_api_data(cls, data, *args, **kwargs):  # noqa: E501
        """CallBackRequestOtpUpdate - a model

        Args:
            data ([DataOtp]): Event data, grouped in multiple objects (up to 200 in a request)

        Keyword Args:
            event (str): defaults to "otp_update", must be one of ["otp_update", ]  # noqa: E501
        ...
        event = kwargs.get('event', "otp_update")
