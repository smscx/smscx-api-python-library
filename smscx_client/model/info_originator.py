...
class InfoOriginator(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, id, originator, *args, **kwargs):  # noqa: E501
        """InfoOriginator - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, originator, *args, **kwargs):  # noqa: E501
        """InfoOriginator - a model
