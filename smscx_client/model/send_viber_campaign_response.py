...
class SendViberCampaignResponse(ModelNormal):
    ...
    def api_types():
        ...
        lazy_import()
        return {
            'info': (InfoViberCampaign,),  # noqa: E501
            'data': ([DataViber],),  # noqa: E501
        }
    ...
    def _from_api_data(cls, info, data, *args, **kwargs):  # noqa: E501
        """SendViberCampaignResponse - a model

        Args:
            info (InfoViberCampaign):
            data ([DataViber]): 
