...
class PricingSmsResponse(ModelNormal):
    ...
    def api_types():
        ...
        lazy_import()
        return {
            'country_code': ({str: (NetworkOperator,)},),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, country_code, *args, **kwargs):  # noqa: E501
        """PricingSmsResponse - a model

        Args:
            country_code ({str: (NetworkOperator,)}): Every **countryCode** object contains objects of network operators and their coresponding pricing
