...
def lazy_import():
    ...
    globals()['ReportsSummaryCountryResponseDataValue'] = ReportsSummaryCountryResponseDataValue


class ReportsSummaryCountryResponse(ModelNormal):
    ...
    def api_types():
        ...
        lazy_import()
        return {
            'data': ({str: (ReportsSummaryCountryResponseDataValue,)},),  # noqa: E501
        }
    ...
    def _from_api_data(cls, data, *args, **kwargs):  # noqa: E501
        """ReportsSummaryCountryResponse - a model

        Args:
            data ({str: (ReportsSummaryCountryResponseDataValue,)}):
