...
class InfoDeleteGroup(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, id, name, total_phone_numbers, *args, **kwargs):  # noqa: E501
        """InfoDeleteGroup - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, total_phone_numbers, *args, **kwargs):  # noqa: E501
        """InfoDeleteGroup - a model
