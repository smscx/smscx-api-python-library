...
class InfoNumbersValidate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, total_phone_numbers, total_valid, total_invalid, phone_numbers_by_country, *args, **kwargs):  # noqa: E501
        """InfoNumbersValidate - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, total_phone_numbers, total_valid, total_invalid, phone_numbers_by_country, *args, **kwargs):  # noqa: E501
        """InfoNumbersValidate - a model
