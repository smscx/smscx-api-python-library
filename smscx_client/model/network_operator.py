...
class NetworkOperator(ModelNormal):
    ...
    def api_types():
        ...
        """
        return {
            'operator_name': ({str: (float,)},),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, operator_name, *args, **kwargs):  # noqa: E501
        """NetworkOperator - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, operator_name, *args, **kwargs):  # noqa: E501
        """NetworkOperator - a model
