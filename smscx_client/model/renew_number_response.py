...
def lazy_import():
    from smscx_client.model.info_renew_number import InfoRenewNumber
    globals()['InfoRenewNumber'] = InfoRenewNumber


class RenewNumberResponse(ModelNormal):
    ...
    def api_types():
        ...
        lazy_import()
        return {
            'info': (InfoRenewNumber,),  # noqa: E501
        }
    ...
    def _from_api_data(cls, info, *args, **kwargs):  # noqa: E501
        """RenewNumberResponse - a model

        Args:
            info (InfoRenewNumber):
