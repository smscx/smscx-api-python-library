...
class GetInboundSMSResponse(ModelNormal):
    ...
    def _from_api_data(cls, info, data, paging, *args, **kwargs):  # noqa: E501
        """GetInboundSMSResponse - a model

        Args:
            info (InfoInboundSms):
            data ([DataReceiveSms]): List of received SMS (newest received first in list)
            paging (Paging):
