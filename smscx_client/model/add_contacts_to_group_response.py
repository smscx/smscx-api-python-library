...
def lazy_import():
    ...
    globals()['InfoGroupsAddContactsResponse'] = InfoGroupsAddContactsResponse


class AddContactsToGroupResponse(ModelNormal):
    ...
    def api_types():
        ...
        lazy_import()
        return {
            'info': (InfoGroupsAddContactsResponse,),  # noqa: E501
        }
    ...
    def _from_api_data(cls, info, *args, **kwargs):  # noqa: E501
        """AddContactsToGroupResponse - a model

        Args:
            info (InfoGroupsAddContactsResponse):
