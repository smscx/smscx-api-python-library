...
class OptoutsNewRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, phone_numbers, allow_invalid, *args, **kwargs):  # noqa: E501
        """OptoutsNewRequest - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, phone_numbers, allow_invalid, *args, **kwargs):  # noqa: E501
        """OptoutsNewRequest - a model
