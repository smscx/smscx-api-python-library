...
class DataSummary(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, phone_numbers, parts, cost_parts, *args, **kwargs):  # noqa: E501
        """DataSummary - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, phone_numbers, parts, cost_parts, *args, **kwargs):  # noqa: E501
        """DataSummary - a model
