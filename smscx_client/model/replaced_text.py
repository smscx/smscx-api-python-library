...
class ReplacedText(ModelNormal):
    ...
    def api_types():
        ...
        return {
            ...
            'characters': (CharactersReplaced,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, text, length, parts, encoding, characters, *args, **kwargs):  # noqa: E501
        """ReplacedText - a model

        Args:
            text (str): Text after the conversion of Unicode characters to GSM alphabet
            length (int): Length of the converted text
            parts (int): Message parts
            encoding (str): Encoding of the converted text
            characters (CharactersReplaced):
    ...
    @convert_js_args_to_python_args
    def __init__(self, text, length, parts, encoding, characters, *args, **kwargs):  # noqa: E501
        """ReplacedText - a model
