...
class InfoAttachment(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, id, name, short_url, file_url, file_type, date_created, hits, *args, **kwargs):  # noqa: E501
        """InfoAttachment - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, short_url, file_url, file_type, date_created, hits, *args, **kwargs):  # noqa: E501
        """InfoAttachment - a model
