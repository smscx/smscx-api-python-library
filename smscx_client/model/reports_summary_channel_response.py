...
def lazy_import():
    ...
    globals()['ReportsSummaryChannelResponseDataValue'] = ReportsSummaryChannelResponseDataValue


class ReportsSummaryChannelResponse(ModelNormal):
    ...
    def api_types():
        ...
        lazy_import()
        return {
            'data': ({str: (ReportsSummaryChannelResponseDataValue,)},),  # noqa: E501
        }
    ...
    def _from_api_data(cls, data, *args, **kwargs):  # noqa: E501
        """ReportsSummaryChannelResponse - a model

        Args:
            data ({str: (ReportsSummaryChannelResponseDataValue,)}):
