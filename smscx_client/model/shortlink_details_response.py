...
class ShortlinkDetailsResponse(ModelNormal):
    ...
    def api_types():
        ...
        lazy_import()
        return {
            'info': (InfoShortlinkDetail,),  # noqa: E501
            'data': ([DataShortlinkDetail],),  # noqa: E501
    ...
    def _from_api_data(cls, info, data, paging, *args, **kwargs):  # noqa: E501
        """ShortlinkDetailsResponse - a model

        Args:
            info (InfoShortlinkDetail):
            data ([DataShortlinkDetail]): 
            paging (Paging):
