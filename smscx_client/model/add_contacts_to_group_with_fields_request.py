...
class AddContactsToGroupWithFieldsRequest(ModelNormal):
    ...
    def api_types():
        ...
        lazy_import()
        return {
            'phone_numbers': ([GroupAdd],),  # noqa: E501
    ...
    def _from_api_data(cls, phone_numbers, *args, **kwargs):  # noqa: E501
        """AddContactsToGroupWithFieldsRequest - a model

        Args:
            phone_numbers ([GroupAdd]): An array of objects if you want to add custom fields data to your contacts


            allow_invalid (bool): Set value `true` to not throw an error if invalid numbers are detected. [optional] if omitted the server will use the default value of False  # noqa: E501
        """
