...
class DataNumberValidate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, phone_number, country_iso, network_operator, timezone, *args, **kwargs):  # noqa: E501
        """DataNumberValidate - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, phone_number, country_iso, network_operator, timezone, *args, **kwargs):  # noqa: E501
        """DataNumberValidate - a model
