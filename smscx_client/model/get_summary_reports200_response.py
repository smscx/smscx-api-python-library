...
class GetSummaryReports200Response(ModelComposed):
    ...
    def api_types():
        ...
        lazy_import()
        return {
            'data': ({str: (ReportsSummaryTrafficResponseDataValue,)},),  # noqa: E501
        }
    ...
    def _from_api_data(cls, *args, **kwargs):  # noqa: E501
        """GetSummaryReports200Response - a model


            data ({str: (ReportsSummaryTrafficResponseDataValue,)}): [optional]  # noqa: E501
        """
    ...
    def _composed_schemas():
        ...
        return {
          ...
          'oneOf': [
              ReportsSummaryChannelResponse,
              ReportsSummaryCountryResponse,
              ReportsSummaryDeliveryResponse,
              ReportsSummarySourceResponse,
              ReportsSummaryTrafficResponse,
          ],
        }
