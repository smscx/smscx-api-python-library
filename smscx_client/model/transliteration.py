...
class Transliteration(ModelNormal):
    ...
    allowed_values = {
        ('alphabet',): {
            ...
            'GREEK': "GREEK",
            'ROMANIAN': "ROMANIAN",
            'RUSSIAN_CYRILLIC': "RUSSIAN_CYRILLIC",
            'BULGARIAN_CYRILLIC': "BULGARIAN_CYRILLIC",
            'UKRAINIAN_CYRILLIC': "UKRAINIAN_CYRILLIC",
            'BELARUSIAN_CYRILLIC': "BELARUSIAN_CYRILLIC",
    ...
    def api_types():
        ...
        """
        return {
            'alphabet': (str,),  # noqa: E501
            'remove_emojis': (bool,),  # noqa: E501
        }
    ...
    attribute_map = {
        'alphabet': 'alphabet',  # noqa: E501
        'remove_emojis': 'removeEmojis',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, alphabet, *args, **kwargs):  # noqa: E501
        """Transliteration - a model
        ...
        Args:
            ...
            remove_emojis (bool): This is optional and defaults to `false`. If set to `true` all Emojis found in the text will be removed. [optional] if omitted the server will use the default value of False  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, alphabet, *args, **kwargs):  # noqa: E501
        """Transliteration - a model
