...
class InfoShortlinkDetail(ModelNormal):
    ...
    attribute_map = {
        'id': 'id',  # noqa: E501
        'name': 'name',  # noqa: E501
        'short_url': 'shortUrl',  # noqa: E501
        'original_url': 'originalUrl',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_api_data(cls, id, name, short_url, original_url, date_created, hits, *args, **kwargs):  # noqa: E501
        """InfoShortlinkDetail - a model
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, short_url, original_url, date_created, hits, *args, **kwargs):  # noqa: E501
        """InfoShortlinkDetail - a model
